...
''', Fore.YELLOW, 0.0001)
       ...
       if  escolha  ==  "1" :
                ...
                escrever_texto ( " \n Certo dia, você entrou em um bar no centro da cidade, onde aprendeu uma história sobre um tesouro secreto capaz de mudar sua vida para sempre. \n " , Fore . GREEN )
       else :
...
def  interacao_balconista ():
    ...
    escrever_texto ( " \n Enquanto você aproveita sua bebê em paz, o balconista começa a falar com você... \n " , Fore . GREEN , 0.05 )
    ...
    if  escolha  ==  '1' :
        ...
        escrever_texto ( " - ao ouvir sobre os supostos tesouros, você fica com vontade de ir explorar essa caverna \n " , Fore . GREEN , 0.05 )
        ...
        escrever_texto ( " (você ainda o balconista com cara série, mas ele começa a contar a história, ignorando seu desinteresse)" , Fore . GREEN , 0.05 )
        escrever_texto ( " há uma caverna ao sul desta cidade, onde dizem que habita um dragão \n " , Fore . BLUE , 0.05 )
        
        escrever_texto ( " \n -Balconista João: Dizem também que há tesouros inimagináveis ​​escondidos lá dentro, esperando para serem descobertos." , Fore . BLUE , 0.05 )
        escrever_texto ( "- ao ouvir sobre os tesouros, você começa a se interessar pela história \n " , Fore . GREEN , 0.05 )
